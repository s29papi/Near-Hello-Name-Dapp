...
impl HelloContract  {
    pub fn output(&self) -> &str  {
     ...
     pub fn input(&mut self, name: String) {
...
mod tests {
 ...
 fn create_value_and_get_value() {
     ...
     contract.input("Bieber!".to_string());
     println!("Greeting after calling create_value(func): {}", contract.output());
     // confirm that we are greeting the right person!
     assert_eq!("hello, Bieber!", contract.output());
 }
}
